  ...
  async execute(interaction) {
    ...
    const serverInfoEmbed = new EmbedBuilder()
      ...
      .addFields(
        ...
        { name: "Total Boosts", value: `${guild.premiumSubscriptionCount}` },
        {
          name: "AFK Channel",
        ...
        { name: "AFK Timeout", value: `${guild.afkTimeout / 60} minutes` },
        {
          ...
          value: explicitContentFilterLevels[guild.explicitContentFilter],
        },
        { name: "Roles Count", value: `${guild.roles.cache.size}` },
        { name: "Emojis Count", value: `${guild.emojis.cache.size}` },
        { name: "Stickers Count", value: `${guild.stickers.cache.size}` }
      )
